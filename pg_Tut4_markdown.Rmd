...
![](im_T3CodeChunkOptions.png){width="600"}
...
![](im_T3CodeChunkOptionsComplete.png){width="600"}
...
![](im_T3CodeChunkOptionsView.png){width="700"}

This will open a menu where you can choose many of the common options

![](im_T3CodeChunkOptionsViewMenu.png){width="400"}
