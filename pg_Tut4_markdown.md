...
<img src="pg_Tut4_markdown_fig1.png" width="50%" style="display: block; margin: auto;" />
...
<img src="pg_Tut4_markdown_fig4.png" width="80%" style="display: block; margin: auto;" />
...
## Tutorial 4f: Code chunks {#Tut4F_chunk}

Read this!  Super short and describes it better than I do.. <https://rmarkdown.rstudio.com/lesson-3.html>
...
The code inside chunks can be altered.  For example, on line 19, delete `summary(cars)` and type `1+1`.  Now press the green arrow and the new answer should appear directly under your code chunk.  
