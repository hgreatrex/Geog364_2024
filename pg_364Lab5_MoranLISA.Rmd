...
1.  Look on Canvas. You will see that there is a new dataset and a new report template. REFRESH YOUR PAGE TO SEE DETAILS.\
...
3.  **But first note you have already done a lot of the work! (e.g. you can copy/paste ANYTHING you wrote in the lab so far) - and remember the readings on canvas or the lecture notes (feel free to include screenshots)\
    \
    The coding should also be easy because you are copy/pasting your code from this example into your new report and just changing the table/variable name. e.g. instead of** `PennACS_sf$total.pop` you might have \
4.  Your tutorial should include the following, \
    ...
    -   A brief description and map of a [**single variable**]{.underline} **of your choice,** commenting what the data is showing and what processes might have caused any pattern you see (population density? climate?)\
    -   A global moran's scatterplot and test for that variable, both standard and monte carlo - explaining what is going on in each case\
    -   A LISA analysis for that variable, explaining how the LISA map links back to your moran's scatterplot
