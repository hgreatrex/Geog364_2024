...
```{=html}
<p class="comment"><strong>You are going to submit this file SEPARATELY. If you put it all in one file, you can re-download the tutorial lab template and copy/paste your work across (Easier in source view, not the fancy visual view) </strong></p>
```
...
```{=html}
<p class="comment"><strong>THIS IS DIFFERENT TO PREVIOUS LABS. <br> You are going to submit your Richmond example and your main lab script separately.  If you put it all in one file, you can re-download the Week2- lab template and copy/paste your Richmond work across (Easier in source view, not the fancy visual view) </strong></p>
```

### For the main lab-script

1. Save your work throughout and spell check your writing (button next to the save button). 
2. Press the knit button one final time If you have not made any mistakes in the code then R should create a html file in your lab5 folder, complete with a very recent time-stamp.

### For your Richmond worked example

Ideally, I want you to submit this as a separate file.   If you put it all in the main lab script, you can re-download the Week2- lab template and copy/paste your Richmond work across (Easier in source view, not the fancy visual view)

1. Save your Richmond tutorial .Rmd and spell check your writing (button next to the save button). 
2. Press the knit button one final time If you have not made any mistakes in the code then R should create a SECOND html file in your lab5 folder, complete with a very recent time-stamp.

<br>

### If you use the POSIT cloud website

You are going to download FOUR files:
  -  Your html and your .Rmd file for your main lab 5 (up to/including section H).<br>
  -  Your html and your .Rmd file for your Richmond tutorial (Section I).<br>


You can download each of your .RmD and html files by:

-   Clicking on the little box next to the Rmd in the Files tab, then going to the little blue cogwheel (might need to make your Rstudio full screen) and clicking export.Repeat the process exactly for the html file underneath it (e,g, just have the html clicked.) <br>
...
Now go to Canvas and submit ALL FOUR of your html and your .Rmd file in Lab 5

<br>

### If you use the RSTudio desktop on your own computer

-   Go to your Lab 5 folder, In that folder, double click on BOTH html files. This will open it in your browser. CHECK THAT THESE ARE WHAT YOU WANT TO SUBMIT <br>

-   Now go to Canvas and submit FOUR FILES:
  -  Your html and your .Rmd file for your main lab 5 (up to/including section H).<br>
  -  Your html and your .Rmd file for your Richmond tutorial (Section I).<br>
...
[160 marks total]
[130 marks for your main lab]
[30 marks for your tutorial]
